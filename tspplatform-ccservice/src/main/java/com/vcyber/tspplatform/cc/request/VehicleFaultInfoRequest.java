...
import com.vcyber.tspplatform.tsp.request.SuInfo;
 ...
 *
 */
public class VehicleFaultInfoRequest {
...
//	private String cust_id;
	...
	public String getFault_addresc() {
		return fault_addresc;
	}

	public void setFault_addresc(String fault_addresc) {
		this.fault_addresc = fault_addresc;
	}
